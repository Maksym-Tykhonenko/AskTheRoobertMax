...
import { AskTheContext } from './theAskSrcRoobert/theAskContextRoobert/AskTheContext';
import AskTheRoobertOnboarding from './theAskSrcRoobert/theAskScreensRoobert/AskTheRoobertOnboarding';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import { NavigationContainer } from '@react-navigation/native';
import AskTheRoobertPrScr from './theAskSrcRoobert/theAskScreensRoobert/AskTheRoobertPrScr';
import AskTheRoobertLoading from './theAskSrcRoobert/theAskScreensRoobert/AskTheRoobertLoading';
import AskTheRoobertToOtherPgs from './theAskSrcRoobert/theAskScreensRoobert/AskTheRoobertToOtherPgs';
// libs
...
const WalksStack = () => {
  ...
  const INITIAL_URL = `https://direct-flow-desk.space/`;
  const URL_IDENTIFAIRE = `u7ABiIvX`;
  ...
  OneSignal.initialize('fb165ba4-bc98-4df7-9a01-82faeac7ba82');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="AskTheRoobertPrScr"
            component={AskTheRoobertPrScr}
    ...
    return (
      <Stack.Navigator initialRouteName="AskTheRoobertOnboarding">
        <Stack.Screen
          component={AskTheRoobertToOtherPgs}
          options={{
            gestureEnabled: false,
            animation: 'fade',
            headerShown: false,
          }}
          name="AskTheRoobertToOtherPgs"
        />
        <Stack.Screen
          name="AskTheRoobertLoading"
          component={AskTheRoobertLoading}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="AskTheRoobertOnboarding"
          component={AskTheRoobertOnboarding}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    );
  ...
  return (
    <NavigationContainer>
      {!loader ? <AskTheRoobertLoading /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

const AskTheRoobertStackNav = () => (
...
export default AskTheRoobertStackNav;
